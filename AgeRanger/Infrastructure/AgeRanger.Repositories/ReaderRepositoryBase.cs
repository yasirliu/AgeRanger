...
namespace AgeRanger.Repositories
{
    ...
    public abstract class ReaderRepositoryBase<TEntity> : RepositoryBase<TEntity>, IEntityReaderContract<TEntity> where TEntity: Entity, new()
    {
        public ReaderRepositoryBase(IDbContextContract context):base(context)
        {
